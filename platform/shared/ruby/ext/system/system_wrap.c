...
/*@SWIG:C:\Programmierung\swigwin-2.0.7\Lib\ruby\rubyprimtypes.swg,19,%ruby_aux_method@*/
...
SWIGINTERN VALUE
_wrap_appfullyinitialized(int argc, VALUE *argv, VALUE self) {
  if ((argc < 0) || (argc > 0)) {
...
SWIGEXPORT void Init_System(void) {
  ...
  rb_define_module_function(mSystem, "appfullyinitialized", _wrap_appfullyinitialized, -1);
